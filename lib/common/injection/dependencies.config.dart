...
import 'package:character_viewer/common/injection/api_module.dart' as _i20;
...
import 'package:character_viewer/common/repository/characters_repository.dart'
    as _i15;
import 'package:character_viewer/common/service/character_service.dart' as _i17;
...
import 'package:character_viewer/feature/add_character/cubit/add_character_cubit.dart'
    as _i19;
import 'package:character_viewer/feature/home/cubit/home_cubit.dart' as _i18;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i17.CharactersService>(
        () => _i17.CharactersService(charactersApi: gh<_i11.CharactersApi>()));
    gh.factory<_i18.HomeCubit>(
        () => _i18.HomeCubit(charactersService: gh<_i11.CharactersService>()));
    gh.factory<_i19.AddCharacterCubit>(
        () => _i19.AddCharacterCubit(gh<_i17.CharactersService>()));
    return this;
  }
}
